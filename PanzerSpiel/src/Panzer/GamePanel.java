...
public class GamePanel extends JPanel{
  ...
  public static final String IMAGE_DIR = "images/";					// öffnen des Bilder Ordner
    
  private final Dimension prefSize = new Dimension(1180, 780);		// Bildschirmgröße erzwingen
    
  private ImageIcon backgroundImage;
  private final String[] backgroundImages= new String [] {"bg_mud.jpg", 	// Speicherort der Bilder
                                                          "bg_snow.jpg", 
                                                          "bg_sand.jpg"};
  ...
  public void setBackgroundImage(int imageNumber) {				//Initialisierung der Bilder
